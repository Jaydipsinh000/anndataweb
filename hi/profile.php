...
<main>
  <div class="profile-header">
    <h1>स्वागत है, <?= htmlspecialchars($user['name']) ?>!</h1>
    <a href="../php/logout.php" class="button">लॉग आउट</a>
  </div>

  <!-- Personal Info -->
  <section>
    <h2>व्यक्तिगत जानकारी</h2>
    <p><strong>ईमेल:</strong> <?= htmlspecialchars($user['email']); ?></p>
    <p><strong>मोबाइल:</strong> <?= htmlspecialchars($user['mobile']); ?></p>
    <p><strong>पता:</strong> <?= htmlspecialchars($user['address']); ?></p>
  </section>
  ...
  <section>
    ...
    <ul class="list">
      ...
      <li>
        ...
        <a href="edit_crop.php?id=<?= $crop['id'] ?>" class="button" style="padding:5px 10px;font-size:0.8rem;">संपादित करें</a>
      </li>
      <?php endwhile; ?>
    </ul>
    <?php else: ?>
      <p class="empty-msg">कोई फसल जोड़ी नहीं गई है। <a href="crops.php" class="button" style="padding:5px 10px;font-size:0.8rem;">➕ फसल जोड़ें</a></p>
    <?php endif; ?>
  </section>
  ...
  <section>
    ...
    <ul class="list">
      ...
      <li>
        ...
        <a href="edit_tool.php?id=<?= $tool['id'] ?>" class="button" style="padding:5px 10px;font-size:0.8rem;">संपादित करें</a>
      </li>
      <?php endwhile; ?>
    </ul>
    <?php else: ?>
      <p class="empty-msg">कोई उपकरण जोड़ा नहीं गया है। <a href="tools.php" class="button" style="padding:5px 10px;font-size:0.8rem;">➕ उपकरण जोड़ें</a></p>
    <?php endif; ?>
  </section>
</main>
</body>
